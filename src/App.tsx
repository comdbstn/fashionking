      ...
      <section className="scroll-section h-screen w-full bg-black flex items-center relative overflow-hidden">
        ...
        >
          ...
          <motion.img
            ...
            transition={{ duration: 0.8, delay: 0.4 }}
            src={import.meta.env.BASE_URL + "images/section1-phone.png"}
            alt="Phone Mockup"
      ...
      <section className="scroll-section h-screen w-full bg-black relative overflow-hidden">
        ...
        >
          <motion.img
            ...
            viewport={{ once: true, amount: 0.3 }}
            transition={{ duration: 0.8, delay: 0.4 }}
            src={import.meta.env.BASE_URL + "images/section2-iphone.png"}
                  ...
                  >
                    <div className="relative h-full p-4">
                      <motion.img
                        ...
                        viewport={{ once: true, amount: 0.3 }}
                        transition={{ duration: 0.8, delay: 0.4 }}
                        src={import.meta.env.BASE_URL + "images/screen1,2.png"}
                ...
                <div className="relative w-full max-w-2xl">
                  ...
                  >
                    <motion.img
                      ...
                      viewport={{ once: true, amount: 0.3 }}
                      transition={{ duration: 0.8, delay: 0.4 }}
                      src={import.meta.env.BASE_URL + "images/section5-vsimage.png"}
                      alt="Battle System"
                ...
                <div className="relative w-full max-w-2xl">
                  ...
                  >
                    <motion.img
                      ...
                      viewport={{ once: true, amount: 0.3 }}
                      transition={{ duration: 0.8, delay: 0.4 }}
                      src={import.meta.env.BASE_URL + "images/section6-trophy.png"}
